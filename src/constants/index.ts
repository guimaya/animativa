...
export const cariocaRanking = [
  ...
  { name: 'GB COMERCIO E SERVICOS LTDA', position: 4 },
  { name: 'LOJAS TEM VARIEDADES LTDA', position: 5 },
  { name: 'DARNY MENDES PICANCO 00098505203', position: 6 },
  { name: 'LEITURA CAMPINAS LTDA', position: 7 },
  { name: 'PRIVALIA BRASIL S.A', position: 8 },
