...
export default function WarnerSection() {
  ...
  return (
    <section className="flex flex-col justify-center bg-warner bg-cover bg-no-repeat p-12  lg:min-w-full">
      <div className="container flex flex-col justify-between sm:flex-row">
        ...
        <div className="px-20 pt-10 sm:px-0 sm:pt-0">
          ...
          <div
            ...
            [&_a]:text-black [&_div]:flex [&_div]:h-12 [&_div]:w-[22rem] [&_div]:items-center [&_div]:justify-center [&_div]:rounded-full [&_div]:bg-white [&_div]:text-center 
              sm:[&_div]:w-96"
          >
            {rankingItems}
          </div>
